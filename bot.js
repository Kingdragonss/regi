...
'9': `<a:9_:809444399061794846>`}[d];
    ...
    var kontrol;
  if (kurulus < 1296000000) kontrol = '**Hesap Durumu:** Güvenilir Değil <a:hydrasiren:792010270037114890>'
  if (kurulus > 1296000000) kontrol = '**Hesap Durumu:** Güvenilir <a:hydratk:798145168758669332> '
    moment.locale("tr");
 ...
 • Hesabın (**`  + moment(member.user.createdAt).format("DD MMMM YYYY dddd") +`**) tarihinde oluşturuldu     
 
 • `+ kontrol + `  
 
 • Kaydını tamamlamak için herhangi bir **V.Confirmed** odasına girmen yeterlidir. 
 
 • <@&${ayarlar.KayıtYetkilisi}> Rolüne sahip kişiler seninle ilgilenecektir.
 
 • Tagımızı alarak ailemizin bir parçası olabilirsin.  
 
 • Aramıza Hoşgeldin! <a:hydrarenklikalp:792002326285254666>`)
